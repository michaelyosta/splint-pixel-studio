...
| `guided-player.spec.js` | 1 / 3 | C, iP, Px | 1200 autofocus, exploration and return | A | deterministic `seed-cohort-template` control fixture; per-test user | 16 ms and 1500 ms waits; one response catch; overlaps tiled low zoom; treatment specials covered separately |
