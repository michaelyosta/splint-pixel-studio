...
| [catalog-publishing.md](catalog-publishing.md) | Canonical 320-item asset and database publication sequence | Canonical delivery contract | Publishing catalog content or migrating catalog assets | Demo seeding or production proof without direct evidence |
