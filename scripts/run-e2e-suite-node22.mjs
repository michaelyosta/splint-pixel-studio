...
const critical = [
  ...
  { file: 'e2e/creator.spec.js', title: '11. Delete a user-created coloring from profile' },
  { file: 'e2e/guided-path.spec.js', title: 'catalog is the default and primary navigation has exactly three product tabs' },
  { file: 'e2e/guided-path.spec.js', title: 'completion hands the finished work to profile or catalog without progression rewards' },
...
const criticalPixelPartitionA = new Set([
  ...
  '11. Delete a user-created coloring from profile',
  'completion hands the finished work to profile or catalog without progression rewards',
